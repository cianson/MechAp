...
namespace MechAp
{
    public static class VehicleService 
    {
        ...
        public static string GetMtnFileName(string vehicleCode, string selectedMenuItem)
        {
            ...
            switch(selectedMenuItem)
            {
                case "Check Tire Pressure":
                    fileName = "tirePressure.pptx";
                    break;
                case "Tire Change":
                    fileName = "Example Procedure.pptx";
                    break;
                case "Change Wiper Blades":
                    fileName = "wiperBlade.pptx";
                    break;
                case "Change Headlight Bulb":
                    fileName = fileName + "_headlightBulb.pptx";
                    break;
                case "Change Taillight Bulb":
                    fileName = fileName + "_taillightBulb.pptx";
                    break;
                case "Change Cabin Air Filter":
                    if(vehicleCode == "007002G1")
                    {
                        fileName = "007002G1G3";
                    }
                    else if(vehicleCode == "007002G2")
                    {
                        fileName = "007002G1G3";
                    }
                    else if(vehicleCode == "007002G3")
                    {
                        fileName = "007002G1G3";
                    }
                    fileName = fileName + "_cabinAirFilter.pptx";
                    break;
                case "Change Intake Air Filter":
                    fileName = fileName + "_intakeAirFilter.pptx";
                    break;
                case "Change Front Brake Pads":
                    fileName = fileName + "_frontBrakes.pptx";
                    break;
                case "Change Rear Brake Pads/Drums":
                    fileName = fileName + "_rearBrakes.pptx";
                    break;
                case "Engine Oil Change":
                    fileName = fileName + "_oilChange.pptx";
                    break;
            }
            return fileName;
        }
        public static MtnProcedure GetprocedureSelected(string vehiclecode, string selectedMenuItem)
        {
            ...
            { url = GetUrl(fileName); }
            else if (vehiclecode == "007002G4")
            { url = GetUrl(fileName); }
            else { url = "https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.public.asu.edu%2F~alrami11%2Fcapstone%2FExample%2520Procedure.pptx&wdOrigin=BROWSELINK"; }

            if(fileName == "tirePressure.pptx" || fileName == "wiperBlade.pptx" || fileName == "Example Procedure.pptx") { url = GetUrl(fileName); }
        ...
        {
            string url = "https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.public.asu.edu%2F~alrami11%2Fcapstone%2F" + filename + "&wdOrigin=BROWSELINK";
            return url;
        }
    }
}
